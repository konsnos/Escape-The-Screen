...
namespace EscapeTheScreen
{
    ...
    /// </summary>
    public enum SCREEN_STATES { BOOT, LOG_IN, DESKTOP, RECYCLE_BIN, UNSORTED, DRIVERS, COMP_SCIENCE, ME_N_BABE, PACKMAN_DOC, README_DOC, DRIVER_INSTALLED };

    /// <summary>
    /// Buttons ids.
    /// </summary>
    public enum BUTTONS { NONE, RECYBLE_BIN, USER, UNSORTED, CLOSE, DRIVERS, COMPUTER_SCIENCE_DOC, ME_N_BABE, PACMAN_DOC, README_TXT, DRIVER_PRINTER, DRIVER_GPU, DRIVER_CAMERA, HINT };
